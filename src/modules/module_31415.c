...
static const char *HASH_NAME      = "Encrypted wtv-flashrom Signature Key - 3DES(PT=$salt, IV=sha1($pass)[2..9], key=sha1($pass).sha1($pass)[0..3])";
static const u64   KERN_TYPE      = 31415;
static const u32   OPTI_TYPE      = OPTI_TYPE_ZERO_BYTE;
static const u64   OPTS_TYPE      = OPTS_TYPE_PT_GENERATE_BE
                                  | OPTS_TYPE_ST_HEX;
static const u32   SALT_TYPE      = SALT_TYPE_EMBEDDED;
static const char *ST_PASS        = "coolbeans";
static const char *ST_HASH        = "c9120ede021b5ac4:308203a702010030";
...
{
  // This is used to unroll loops in OpenCL code.
  // This is for a performance boot so we're not checking variables on every iteration.
  ...
  // NVIDIA GPU
  else if (device_param->opencl_device_vendor_id == VENDOR_ID_NV)
  {
    hc_asprintf (&jit_build_options, "-D _unroll");
  }
  // HIP
