...
#endif
//
//10110000010101000101110000001000
//  110000010101000101110000001000

//110010000010000010110000001
//110010000010000010111000001
...
void DES_test_key(const_DES_cblock *key, DES_key_schedule *schedule)
{
    ...
    for (i = 0; i < ITERATIONS; i++) {
        ...
        | des_skb[1][((c >> 6L) & 0x03) 
            | ((c >> 7L) & 0x3c)]
        | des_skb[2][((c >> 13L) & 0x0f)
            | ((c >> 14L) & 0x30)] |
        des_skb[3][((c >> 20L) & 0x01)
            | ((c >> 21L) & 0x06)
            | ((c >> 22L) & 0x38)];
        ...
        /*printf("s=%08x | %08x | %08x | %08x [%08x: %08x|%08x|%08x]\n",
            ...
            c, ((c >> 20L) & 0x01), ((c >> 21L) & 0x06), ((c >> 22L) & 0x38)
        );*/
...
void DES_test(DES_LONG *data, DES_key_schedule *ks, int enc)
{
